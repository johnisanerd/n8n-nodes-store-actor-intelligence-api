...
import { ACTOR_ID } from '../ApifyStore.node';
import { buildActorInput } from '../ApifyStore.properties';
...
/**
 * Shape a single Apify Store Actor according to the chosen Output mode.
...
function shapeItem(
	...
	return {
		...
		successRate30Days: item.successRate30Days,
